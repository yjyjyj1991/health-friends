package com.healthfriend.healthfriend.util.page;
...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		buffer.append("			</li> \n");
		buffer.append("			<li class=\"page-item\"> \n");
		buffer.append("				<a href=\"#\" class=\"page-link\" move-pg=\"" + (this.startRange ? 1 : (startPage - 1))
				+ "\">이전</a> \n");
		buffer.append("			</li> \n");
		for (int i = startPage; i <= endPage; i++) {
			buffer.append("			<li class=\"" + (currentPage == i ? "page-item active" : "page-item")
					+ "\"><a href=\"#\" class=\"page-link\" move-pg=\"" + i + "\">" + i + "</a></li> \n");
		}
		buffer.append("			<li class=\"page-item\"> \n");
		buffer.append("				<a href=\"#\" class=\"page-link\" move-pg=\"" + (this.endRange ? endPage : (endPage + 1))
				+ "\">다음</a> \n");
		buffer.append("			</li> \n");
		buffer.append("			<li class=\"page-item\"> \n");
